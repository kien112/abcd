    ...
    <body>
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <form class ="signup-form" action="/LearningEnglish/register" method="post">
                    ...
                    <input type="text" name="email" id="name" onfocusout="CheckMail(this)"  placeholder="Email" required/><br>
                    <p id="mess3"></p>
        ...
        <script>
            ...
            function CheckMail(t){
                $.ajax({
                    type: "GET",
                    url: "/LearningEnglish/checkMail",
                    data: {
                        content: t.value
                    },
                    success: function (data) {
                        document.getElementById("mess3").innerHTML = data;
                    }
                });
            }
